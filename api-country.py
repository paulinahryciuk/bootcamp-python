{"name": {"common": "Greece", "official": "Hellenic Republic",
          "nativeName": {"ell": {"official": "Ελληνική Δημοκρατία", "common": "Ελλάδα"}}}, "tld": [".gr"], "cca2": "GR",
 "ccn3": "300", "cca3": "GRC", "cioc": "GRE", "independent": true, "status": "officially-assigned", "unMember": true,
 "currencies": {"EUR": {"name": "Euro", "symbol": "€"}}, "idd": {"root": "+3", "suffixes": ["0"]},
 "capital": ["Athens"], "altSpellings": ["GR", "Elláda", "Hellenic Republic", "Ελληνική Δημοκρατία"],
 "region": "Europe", "subregion": "Southern Europe", "languages": {"ell": "Greek"},
 "translations": {"ara": {"official": "الجمهورية الهيلينية", "common": "اليونان"},
                  ...
                  "zho": {"official": "希腊共和国", "common": "希腊"}}, "latlng": [39.0, 22.0], "landlocked": false,
 "borders": ["ALB", "BGR", "TUR", "MKD"], "area": 131990.0,
 "demonyms": {"eng": {"f": "Greek", "m": "Greek"}, "fra": {"f": "Grecque", "m": "Grec"}},
 "flag": "\uD83C\uDDEC\uD83C\uDDF7", "maps": {"googleMaps": "https://goo.gl/maps/LHGcAvuRyD2iKECC6",
                                              "openStreetMaps": "https://www.openstreetmap.org/relation/192307"},
 "population": 10715549, "gini": {"2018": 32.9}, "fifa": "GRE", "car": {"signs": ["GR"], "side": "right"},
 "timezones": ["UTC+02:00"], "continents": ["Europe"],
 ...
 "coatOfArms": {"png": "https://mainfacts.com/media/images/coats_of_arms/gr.png",
                "svg": "https://mainfacts.com/media/images/coats_of_arms/gr.svg"}, "startOfWeek": "monday",
 "capitalInfo": {"latlng": [37.98, 23.73]}, "postalCode": {"format": "### ##", "regex": "^(\\d{5})$"}}
